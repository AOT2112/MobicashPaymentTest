...
internal class PreviewFaqTestData {
    ...
    val oneItem : FaqDataItem
        get() {
            return longFaqDataItem
        }

    private val longFaqDataItem = FaqDataItem(
        "q3-5",
        "How to pay",
